...
export default function TextNarrative() {
  ...
  const text1Y = useTransform(scrollYProgress, [0.15, 0.22], [0, -80]);

  const text2Opacity = useTransform(scrollYProgress, [0.20, 0.28, 0.85, 1], [0, 1, 1, 0]);
  const text2Y = useTransform(scrollYProgress, [0.20, 0.28], [50, 0]);
