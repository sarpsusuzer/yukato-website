...
export default function PlatformHero({
  ...
  return (
    <section ref={sectionRef} className="relative bg-white overflow-hidden h-[95vh] flex flex-col justify-center">
      ...
      <div className="relative z-10 max-w-[1160px] mx-auto px-6 text-center">
        ...
        <h1 className="text-[clamp(32px,5vw,62px)] font-medium leading-[1.15] tracking-[-1px] text-[#282c34] max-w-[800px] mx-auto">
