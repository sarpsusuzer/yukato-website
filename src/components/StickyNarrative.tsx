...
const videoSrcs = [
  `${bp}/videos/nexus.mp4`,
  `${bp}/videos/lighthouse.mp4`,
  `${bp}/videos/yard-management.mp4`,
];
...
export default function StickyNarrative() {
  ...
  const t = useT();
  const sections = t.stickyNarrative.sections;
              ...
              <div className="flex flex-col md:flex-row gap-4 md:gap-16 items-start w-full">
                <div className="flex-1 min-w-0 md:max-w-[380px]">
                  <h3 className="text-[24px] md:text-[32px] font-bold leading-[1.3] md:leading-[60px] tracking-[-1px] text-[#008582]">
                    {section.name}
                    {section.nameSup && <sup className="text-[14px] md:text-[18px]">{section.nameSup}</sup>}
                  </h3>
                  ...
                  <div className="mt-2 md:mt-3">
                    <a href="#" className="inline-flex items-center justify-center h-[36px] md:h-[40px] px-4 rounded-full border border-[#3bc6bd] text-[13px] md:text-[14px] font-bold text-[#21beba] hover:bg-[#21beba]/5 transition-colors duration-200">
                      {section.cta}
                    </a>
                  </div>
                </div>
