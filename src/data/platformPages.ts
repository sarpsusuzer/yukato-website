...
const platformPagesTr: Record<string, PlatformPageData> = {
  tedarikci: {
    ...
    features: [
      ...
      { title: "Teslimat Randevusu Atama", desc: "Depo süreçlerini randevu ile planlayarak bekleme sürelerini azaltın, saha trafiğini düzenleyin.", image: "/web-gorseller/Tedarikçi/tedarikçi2.webp", bullets: ["Sevkiyat kartları üzerinden Rampa Ata butonunu ile kolaylıkla randevu atanabilir.", "Yapılan rampa ve randevu ataması, sürücünün mobil uygulamasına bildirim olarak gönderilir."] },
      { title: "Sürücü Portföyü Oluşturma", desc: "Sevk emirlerinin taşıma sürecinin yürütülmesini sağlayan kullanıcılardır.", image: "/web-gorseller/Tedarikçi/tedarikçi3.webp", bullets: ["Firmanızın personeli", "Nakliye iş ortağınızın personeli", "Serbest çalışan olabilir"] },
      { title: "Gelen Sevkiyatları Anlık Görüntüleme", desc: "Siparişlerinizi ve tahmini varış zamanlarını anlık olarak takip edin, gecikmelere karşı önden aksiyon alın.", image: "/web-gorseller/Tedarikçi/tedarikçi4.webp", bullets: ["Kullanıcı, sevkiyatın genel durumunu buradan takip eder ve gerekli güncellemeleri yapabilir.", "Teslimatlarınızın durumu gerçek zamanlı takip edilir."] },
      { title: "Sipariş Kontrol Sistemi", desc: "Her siparişi tek ekrandan yönetin, yanlış veya eksik sevkiyat riskini ortadan kaldırın.", image: "/web-gorseller/Tedarikçi/tedarikçi5.webp", bullets: ["Araç depoya gelmeden önce, irsaliyelerin ve siparişlerin doğruluğu burada kontrol edilir."] },
      { title: "Anlık Teslimat Onayı Görüntüleme", desc: "Teslimatlarınızın durumunu gerçek zamanlı takip edin, her siparişin başarıyla tamamlanıp tamamlanmadığını anında görün.", image: "/web-gorseller/Tedarikçi/tedarikçi6.webp", bullets: ["Teslimatlarınızın durumu gerçek zamanlı takip edilir.", "Araç depoya gelmeden önce, irsaliyelerin ve siparişlerin doğruluğu burada kontrol edilir."] },
      { title: "Yüklemeye Gelen Araca Randevu Atama", desc: "Araç girişlerini randevu sistemiyle planlayın, saha trafiğini düzenleyip bekleme sürelerini minimuma indirin.", image: "/web-gorseller/Tedarikçi/tedarikçi7.webp", bullets: ["Tüm yükleme sevkiyatları burada listelenir.", "Kullanıcı, sevkiyatın genel durumunu buradan takip eder ve gerekli güncellemeleri yapabilir.", "Yapılan rampa ve zaman ataması, sürücünün mobil uygulamasına bildirim olarak gönderilir.", "Kullanıcı, rampaları ve zaman planlamasını gerektiği takdirde güncelleyebilir."] },
    ],
    supademoTabs: [
  ...
  perakendeci: {
    ...
    features: [
      { title: "Gerçek Zamanlı Teslimat Takibi", desc: "Tüm sevkiyat süreçlerinizi uçtan uca görünür kılarak operasyonel kontrolü elinize alın. Gecikme risklerini ve planlama belirsizliklerini proaktif bir şekilde yöneterek kusursuz bir teslimat deneyimi sunun.", image: "/web-gorseller/Perakendeci/perakendeci1.webp", bullets: ["Sevklerin anlık durumunu tek ekrandan takip edersiniz: yolda, gecikmeli veya teslim edilmiş.", "Tahmini varış zamanları sürekli güncellenir, planlama belirsizliği ortadan kalkar.", "Riskli teslimatlar önceden işaretlenir, ekipler geç kalmadan aksiyon alabilir."] },
      { title: "PO & Sevk Bazlı İzlenebilirlik", desc: "Karmaşık tedarik operasyonlarını yalınlaştırın. Gelişmiş izlenebilirlik sayesinde sipariş durumlarını anlık takip edin, otomatik eşleştirmelerle güvenilir ve eksiksiz bir mal kabul süreci deneyimleyin.", image: "/web-gorseller/Perakendeci/perakendeci 2.webp", bullets: ["Her mal kabul işlemi ilgili satın alma siparişi (PO) ve sevk ile otomatik olarak eşleşir.", "Hangi siparişin nerede olduğu, kim tarafından gönderildiği net şekilde görünür.", "Karışıklık, manuel kontrol ve yanlış kabul riski azalır."] },
      { title: "Merkezi Dashboard", desc: "Operasyonel performansınızı büyük resimde görün. Tedarikçi analizlerinden teslimat trendlerine kadar tüm kritik metrikleri tek merkezden izleyerek stratejik ve güvenilir kararlar alın.", image: "/web-gorseller/Perakendeci/perakendeci3.webp", bullets: ["Günlük, haftalık ve dönemsel mal kabul özetlerine tek yerden erişirsiniz.", "Zamanında teslimat oranları ve gecikme trendleri net şekilde izlenir.", "Tedarikçi bazlı performans görünürlüğü ile kararlar veriye dayanır."] },
      { title: "Gecikme ve Anomali Tespiti", desc: "Planlanan ve gerçekleşen verileri sürekli analiz eden erken uyarı sistemimiz, olası gecikmeleri anında tespit ederek ekiplerinize hızlı müdahale şansı sunar.", image: "/web-gorseller/Perakendeci/perakendeci4.webp", bullets: ["Planlanan teslimat tarihi ile gerçekleşen teslimat otomatik olarak karşılaştırılır.", "Gecikmeler, olağan dışı durumlar ve sapmalar sistem tarafından tespit edilir.", "Operasyon ekipleri sorunu teslim anında değil, öncesinde görür."] },
      { title: "Bildirim ve Bilgilendirme", desc: "Süreçlerinizdeki iletişim karmaşasına son verin. Kritik anlarda doğru ekipleri anında bilgilendiren akıllı altyapımızla manuel takip yükünü ortadan kaldırın ve koordinasyonu güçlendirin.", image: "/web-gorseller/Perakendeci/perakendeci5.webp", bullets: ["Kritik durumlarda ilgili ekipler otomatik olarak bilgilendirilir.", "Manuel takip ihtiyacı azalır, bilgi herkes için aynı anda ve aynı kaynaktan gelir.", "Operasyonel iletişim sadeleşir, telefon ve e-posta trafiği düşer."] },
    ],
    supademoTabs: [
  ...
  nakliyeci: {
    ...
    features: [
      { title: "Boş Kilometrelerde Düşüş", desc: "Teslimat sonrası dönüşe geçen araçların, rotaları üzerindeki tedarikçi alımlarıyla eşleştirilerek sistem genelinde boş yapılan kilometre oranlarında %30 azalma sağlanabilir.", image: "/web-gorseller/Nakliyeci/nakliyeci1.webp", bullets: ["Boş yapılan kilometre oranlarında %30 azalma sağlanır.", "Gereksiz seferlerin önlenmesiyle karbon emisyonlarının (CO2) düşürülerek çevresel sürdürülebilirliğe katkı sağlar.", "Sürücülerin ve filonun yolda geçirdiği atıl zamanı en aza indirerek kapasite kullanımını maksimum seviyeye çıkarır."] },
      { title: "Sevkiyat Birleştirme", desc: "Farklı şirketlere ait ve ayrı ayrı oluşturulmuş ancak aynı arabada taşınacak olan gönderileri seçerek, tek bir sevkiyat altında birleştirilebilir.", image: "/web-gorseller/Nakliyeci/nakliyeci2.webp", bullets: ["Gönderici firmalara doğru bilgi akışı sağlanır.", "Perakende firmalarının mal kabulcülerinin işlemlerini doğru bir şekilde yapabilmesini mümkün kılar."] },
      { title: "Verimli Rota Planlaması", desc: "Araçların daha dolu çalışması sağlanarak daha iyi rota verimliliği elde edilir. Ek olarak, dışarıdan kiralanan araç ihtiyacında haftalık ortalama %20 düşüş görülür.", image: "/web-gorseller/Nakliyeci/nakliyeci3.webp", bullets: ["Mevcut araçların boş kapasitelerinin değerlendirilerek her seferde maksimum doluluk oranıyla çalışmasını sağlar.", "Dışarıdan kiralanan ek araçlara olan operasyonel bağımlılığı düşürerek doğrudan maliyet tasarrufu elde edilir.", "Daha az sayıda araçla daha fazla nakliye işlemini yöneterek genel lojistik süreçlerinde zaman ve kaynak verimliliğini artırır."] },
    ],
    supademoTabs: [
  ...
  surucu: {
    ...
    features: [
      { title: "Atıl Zaman Optimizasyonu", desc: "Mevcut yüklerin, konum olarak en yakındaki uygun ve doğrulanmış sürücülerle anında eşleştirilerek bekleme sürelerinin en aza indirilmesidir.", image: "/web-gorseller/Sürücü/sürücü1.webp", bullets: ["Sürücülerin yük beklerken geçirdikleri atıl saatleri minimum seviyeye düşürerek zaman verimliliğini artırır.", "Yakın konumdaki doğrulanmış sürücülere otomatik görev ataması yapılarak operasyonel sevkiyat süreçlerinin hızlandırır.", "Kesintisiz iş akışı sayesinde sürücülerin günlük çalışma sürelerinin daha verimli kullanılmasını ve genel kapasitenin en üst düzeye çıkarılmasını sağlar."] },
      { title: "Dijital Dokümantasyon Yönetimi", desc: "Tüm sevkiyat evraklarının dijital ortama taşınarak eksik veya hatalı belge kaynaklı zaman kayıplarının önlenmesi ve operasyonel süreçlerin baştan uca hızlandırılmasıdır.", image: "/web-gorseller/Sürücü/sürücü2.webp", bullets: ["Fiziksel evrak takibini ortadan kaldırarak mal kabul ve teslimat işlemlerinin daha hızlı ve hatasız gerçekleştirilebilir.", "Eksik belge onaylarından kaynaklanan depo bekleme sürelerinin önüne geçerek kesintisiz bir iş akışı sağlar.", "Gerekli tüm dokümanları sistem üzerinde toplayarak sürücülerin ve diğer paydaşların evraklara anında erişimini mümkün kılar."] },
    ],
    supademoTabs: [
      { label: "Nakliyeci - Sürücü Atama", id: "cmltbx4jx0vc7d2ntkd66zwfa" },
      { label: "Nakliyeci - Araç Talep Saatine Göre Sürücü Ataması Yapmak", id: "cmltc0xd80vlld2nt8ppax1l2" },
...
const platformPagesEn: Record<string, PlatformPageData> = {
  tedarikci: {
    ...
    features: [
      ...
      { title: "Delivery Appointment Assignment", desc: "Reduce waiting times and organize yard traffic by planning warehouse processes with appointments.", image: "/web-gorseller/Tedarikçi/tedarikçi2.webp", bullets: ["Appointments can easily be assigned via the Assign Dock button on shipment cards.", "The assigned dock and appointment notification is sent to the driver's mobile application."] },
      { title: "Building a Driver Portfolio", desc: "These are the users responsible for executing the transportation process of dispatch orders.", image: "/web-gorseller/Tedarikçi/tedarikçi3.webp", bullets: ["Your company's own personnel", "Your logistics partner's personnel", "Can be a freelancer"] },
      { title: "Real-Time View of Incoming Shipments", desc: "Track your orders and estimated arrival times in real time, take proactive action against delays.", image: "/web-gorseller/Tedarikçi/tedarikçi4.webp", bullets: ["The user monitors the general status of the shipment here and can make necessary updates.", "The status of your deliveries is tracked in real time."] },
      { title: "Order Control System", desc: "Manage every order from a single screen, eliminate the risk of incorrect or missing shipments.", image: "/web-gorseller/Tedarikçi/tedarikçi5.webp", bullets: ["Before the vehicle arrives at the warehouse, the accuracy of waybills and orders is verified here."] },
      { title: "Real-Time Delivery Confirmation View", desc: "Track the status of your deliveries in real time, instantly see whether each order has been successfully completed.", image: "/web-gorseller/Tedarikçi/tedarikçi6.webp", bullets: ["The status of your deliveries is tracked in real time.", "Before the vehicle arrives at the warehouse, the accuracy of waybills and orders is verified here."] },
      { title: "Appointment Assignment for Loading Vehicles", desc: "Plan vehicle entries with an appointment system, organize yard traffic and minimize waiting times.", image: "/web-gorseller/Tedarikçi/tedarikçi7.webp", bullets: ["All outbound shipments are listed here.", "The user monitors the general status of the shipment and can make necessary updates.", "The assigned dock and time notification is sent to the driver's mobile application.", "The user can update the docks and time schedule when necessary."] },
    ],
  },
  perakendeci: {
  ...
  nakliyeci: {
    ...
    features: [
      { title: "Reduction in Empty Kilometers", desc: "By matching vehicles returning after delivery with supplier pickups along their routes, a 30% reduction in empty kilometer rates can be achieved system-wide.", image: "/web-gorseller/Nakliyeci/nakliyeci1.webp", bullets: ["30% reduction in empty kilometer rates.", "Contributes to environmental sustainability by reducing CO2 emissions by preventing unnecessary trips.", "Maximizes capacity utilization by minimizing idle time for drivers and the fleet on the road."] },
      { title: "Shipment Consolidation", desc: "Shipments belonging to different companies that were created separately but will be transported in the same vehicle can be consolidated under a single shipment.", image: "/web-gorseller/Nakliyeci/nakliyeci2.webp", bullets: ["Accurate information flow is provided to the sending companies.", "Enables retail companies' goods receivers to perform their operations correctly."] },
      { title: "Efficient Route Planning", desc: "Better route efficiency is achieved by ensuring vehicles work fuller. Additionally, a weekly average reduction of 20% is seen in the need for externally rented vehicles.", image: "/web-gorseller/Nakliyeci/nakliyeci3.webp", bullets: ["Enables maximum occupancy rates on each trip by utilizing the empty capacities of existing vehicles.", "Achieves direct cost savings by reducing operational dependency on additional externally rented vehicles.", "Increases time and resource efficiency in overall logistics processes by managing more transport operations with fewer vehicles."] },
    ],
    supademoTabs: [
  ...
  surucu: {
    ...
    features: [
      { title: "Idle Time Optimization", desc: "Available loads are instantly matched with the nearest available and verified drivers by location, minimizing waiting times.", image: "/web-gorseller/Sürücü/sürücü1.webp", bullets: ["Increases time efficiency by minimizing idle hours drivers spend waiting for loads.", "Speeds up operational shipment processes by automatically assigning tasks to verified nearby drivers.", "Ensures that drivers' daily working hours are used more efficiently and overall capacity is maximized through uninterrupted workflow."] },
      { title: "Digital Documentation Management", desc: "All shipment documents are transferred to digital media to prevent time losses caused by missing or incorrect documents and to accelerate operational processes end-to-end.", image: "/web-gorseller/Sürücü/sürücü2.webp", bullets: ["Eliminates physical document tracking, allowing goods receipt and delivery operations to be performed faster and more accurately.", "Prevents warehouse waiting times caused by missing document approvals, ensuring an uninterrupted workflow.", "Makes it possible for drivers and other stakeholders to instantly access documents by collecting all required documents on the system."] },
    ],
  },
};
